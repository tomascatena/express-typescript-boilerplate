...
import { getSwaggerRequestBodySchema, getSwaggerResponseBodySchema } from './getSwaggerSchema';
...
const getRequestBody = (subItem: GeneralObject) => getSwaggerRequestBodySchema({
  isRequired: true,
